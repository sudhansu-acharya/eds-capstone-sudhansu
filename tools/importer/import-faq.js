...
const PAGE_TEMPLATE = {
  name: 'faq',
  description: 'FAQ page: hero, FAQ accordion, contact info columns, and join CTA',
  urls: [
  ...
  blocks: [
    ...
    },
    {
      ...
      instances: ['#main-content > section.section.secondary-section .grid-layout.grid-gap-xxl'],
    },
  ],
  sections: [
    ...
    { id: 'section-2', name: 'FAQ accordion', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['accordion-faq'], defaultContent: [] },
    { id: 'section-3', name: "Let's connect", selector: '#main-content > section.section.secondary-section', style: 'secondary', blocks: ['columns-contact'], defaultContent: [] },
    { id: 'section-4', name: 'Join CTA', selector: '#main-content > section.section.accent-section', style: 'accent', blocks: [], defaultContent: ['#main-content > section.section.accent-section h2', '#main-content > section.section.accent-section p', '#main-content > section.section.accent-section a'] },
  ],
};
